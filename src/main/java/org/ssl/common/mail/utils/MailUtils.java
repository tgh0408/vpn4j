package org.ssl.common.mail.utils;
...
public class MailUtils {
    ...
    public static void setProperties(@NonNull MailProperties mailProperties) {
    ...
    public static String sendHtml(String to, String subject, String content, ByteArrayDataSource dataSource) {
        return send(
                ...
                null,
                true,
                new ByteArrayDataSource[]{dataSource}
        );
    }
    ...
    private static String send(Collection<String> tos,
        ...
        String smtpEnable = CacheUtils.get(SystemConfigEnum.smtp_enable);
        if (!Strings.CI.equals(smtpEnable, "1")) {
            throw new ServiceException("SMTP is not enabled");
        }
     ...
     * @since 4.6.3
     */
    private static String send(MailAccount mailAccount,
